...
| AR-05 | Auth, RBAC, permissions, and audit logging | Needs revisit | TBD | Earlier broad database-slice decision was removed before implementation; redesign this topic before adding auth, sessions, RBAC, permissions, audit logs, activity logs, or auth security events. |
