...
| M02 | Crowdfunding and Donation System | Core candidate | Multi-project campaigns, donation targets, donor messages, project/phase/item/general support. | Anonymous donation policy, Donation Wall, full item sponsorship, offline donations. |
...
| M09 | User Accounts, Authentication, and Profiles | Core candidate | Mobile OTP, profile, donation history, settings, possible follows/updates. | OTP provider, anonymous checkout, project follow feature, privacy/data retention. |
